    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', user_account.models.mobile_num_validator(max_length=50, unique=True, validators=[user_account.models.no_repeating_digits_validator, django.core.validators.MaxLengthValidator(10), django.core.validators.MinLengthValidator(6)])),
                ('password', models.CharField(max_length=200)),
                ('otp', models.IntegerField(default=0)),
                ('image', models.ImageField(upload_to='user_image')),
                ('is_staff', models.BooleanField(default=False, verbose_name='is_teacher')),
                ('is_active', models.BooleanField(default=True, verbose_name='is_student')),
